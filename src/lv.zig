...
pub extern const tabler_icon_ripple_S: anyopaque;
pub extern const tabler_icon_ripple_P: anyopaque;
pub extern const tabler_icon_ripple_L: anyopaque;
pub extern const tabler_icon_ripple_N: anyopaque;
