...
/*Color depth: 32 (XRGB8888) for direct Canvas ImageData compatibility*/
...
/* Use LVGL's built-in implementations for WASM (no libc available) */
...
#define LV_USE_DRAW_SW 1
    ...
    /*Enable complex draw engine features (shadow, gradient, etc.)*/
    #define LV_DRAW_SW_COMPLEX          1
    #define LV_DRAW_SW_SHADOW_CACHE_SIZE 0
    #define LV_DRAW_SW_CIRCLE_CACHE_SIZE 0
#endif

/* Disable all HW accelerated renderers */
...
#define LV_USE_LOG 1
#if LV_USE_LOG
    /*How important log should be printed (LV_LOG_LEVEL_TRACE..LV_LOG_LEVEL_NONE)*/
    #define LV_LOG_LEVEL LV_LOG_LEVEL_WARN
    /*printf or a custom function for logging*/
    #define LV_LOG_PRINTF 0
    /*Set a custom trace function (optional)*/
    #define LV_LOG_USE_TIMESTAMP 1
    #define LV_LOG_USE_FILE_LINE 1
    /*Print the log with the flush function*/
    #define LV_LOG_TRACING 0
#endif
...
/*Montserrat fonts - only enable sizes we need*/
...
/*====================
 * FILE SYSTEM (all disabled for WASM)
 *====================*/
...
/*====================
 * DEVICE DRIVERS (all disabled for WASM)
 *====================*/
#define LV_USE_SDL              0
#define LV_USE_X11              0
